...
test.describe('Eligibility journey e2e tests', () => {
  ...
  const runEligibilityTest = async (page, axeUtils, testInfo, testFunction) => {
  ...
  test('Verify eligibility to adopt multiple children.', eligibilityTestTags, async ({ page, axeUtils }, testInfo) => {
    await runEligibilityTest(page, axeUtils, testInfo, async eligibility => {
