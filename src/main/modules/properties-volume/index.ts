...
export class PropertiesVolume {
  enableFor(app: Application): void {
    if (!app.locals.developmentMode) {
      ...
      this.setSecret('secrets.adoption.adoption-token-key', 'services.equalityAndDiversity.tokenKey');
    } else {
      ...
      this.setLocalSecret('adoption-token-key', 'services.equalityAndDiversity.tokenKey');
    }
  }
