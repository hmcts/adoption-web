...
const cy: typeof en = content => ({
  ...
  line10: `The court processing fee for an application is £${content.fee?.FeeAmount}. Payment is due once the application is complete and ready to submit to the court. (in welsh)`,
  line11:
