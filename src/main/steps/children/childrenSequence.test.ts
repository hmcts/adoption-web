...
describe('childrenSequence', () => {
  test('should contain 10 entries in children screen sequence', () => {
    expect(childrenSequence).toHaveLength(10);
    ...
    expect(childrenSequence[5].url).toBe('/children/full-name');
    expect(childrenSequence[5].showInSection).toBe('aboutChildren');
    expect(childrenSequence[5].getNextStep({})).toBe('/children/date-of-birth');
