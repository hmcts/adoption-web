...
export const getCourtEmailId = (key: string): string => {
  ...
  const map = new Map<string, string>([
    ...
    ['kingston upon thames', config.get('localCourt.emailId.KINGSTON_FAMILY_COURT')],
    ['uxbridge', config.get('localCourt.emailId.UXBRIDGE_FAMILY_COURT')],
    ...
    ['carmarthen', config.get('localCourt.emailId.CARMARTHEN_FAMILY_COURT')],
