...
//import { cyNotSure, enNotSure, notSureInput } from '../../birth-father/alive/notSureInput/content';
//import { placementOrderType, placementOrderOtherType} from '../../../app/form/validation';

//const fieldName = 'placementOrderType';
...
/* export const form: FormContent = {
  ...
  fields: userCase =>{
    console.log('userCase.placementOrders---------  '+userCase.placementOrders);
    
    const placementOrder = userCase.placementOrders?.find(
      item => item.placementOrderId === userCase.selectedPlacementOrderId
    );
    console.log('<<<<<OrderType>>>>>>>:   '+placementOrder?.placementOrderType);
...
/* const values = [
 { key: 'adoptionOrder', value: PlacementOrderTypeEnum.AdoptionOrder },
 { key: 'no', value: PlacementOrderTypeEnum.CareOrder },
 { key: 'notSure', value: PlacementOrderTypeEnum.ContactOrder },
 //{ key: 'nFreeingordero', value: PlacementOrderTypeEnum.FreeingOrder },
 //{ key: 'Placementorder', value: PlacementOrderTypeEnum.PlacementOrder },
 //{ key: 'Supervisionorder', value: PlacementOrderTypeEnum.SupervisionOrder },
 //{ key: 'Oher', value: PlacementOrderTypeEnum.Oher },
];  */

/* const values = [
  { key: 'yes', value: YesNoNotsure.YES },
  { key: 'no', value: YesNoNotsure.NO },
  { key: 'notSure', value: YesNoNotsure.NOT_SURE },
]; */
