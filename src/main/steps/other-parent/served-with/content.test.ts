...
describe('other parent > served-with > content', () => {
  ...
  it('should have an otherParentServedWith text input field', () => {
    const fields = (content.form as FormContent).fields as FormFields;
    const field = fields.otherParentServedWith as FormOptions;
    ...
    const field2 = (fields.otherParentServedWith as FormOptions).values[1].subFields!.otherParentNotServedWithReason;
