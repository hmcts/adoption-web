...
const cyContent = {
  ...
  sectionTitles: {
    ...
    childDetails: "Ychwanegu child's details",
  ...
  taskListItems: {
    ...
    birthMother: 'Birth mother details',
    birthFather: 'Birth father details',
    otherParent: 'Arall person with parental responsibility',
    placementAndCourtOrders: 'Placement and court neuders',
    siblingCourtOrders: 'Sibling court neuder details',
