...
export const LA_PORTAL_OTHER_PARENT_RESPONSIBILITY_GRANTED: PageLink = `${LA_PORTAL}${OTHER_PARENT}/parental-responsibility-granted`;
...
export const TEST_REQUEST: PageLink = '/request'; // todo - remove this and update generic tests to use a valid UR
