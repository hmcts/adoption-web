...
export const INELIGIBLE_TO_ADOPT_OVER_18: PageLink = `${ELIGIBILITY_URL}/cannot-apply-over-18`;
export const INELIGIBLE_TO_ADOPT_ALREADY_MARRIED: PageLink = `${ELIGIBILITY_URL}/cannot-apply-married`;
