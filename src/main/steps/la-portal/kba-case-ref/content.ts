...
const en = () => ({
  ...
  childNameLabel: 'Access Code',
  childNameHint: 'This is the 12 digit alphanumeric access code that was on the email sent to you. If it has expired, you can contact us to request a new one.',
