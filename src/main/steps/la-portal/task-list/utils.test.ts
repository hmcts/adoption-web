    ...
    it.each([
      ...
      },
      {
        data: {
          ...
          birthFatherLastAddressDate: { day: '1', month: '1', year: '2021' },
        },
        expected: COMPLETED,
      },
    ])('should return correct status %#', async ({ data, expected }) => {
    ...
    test.each([
      ...
      { data: { otherParentExists: YesOrNo.NO }, userType: 'otherParent', expected: 'COMPLETED' },
      {
        data: {
          ...
          otherParentLastAddressDate: { day: '1', month: '1', year: '2021' },
        },
    ...
    test.each([
      ...
      },
      {
        data: {
          ...
          birthMotherLastAddressDate: { day: '1', month: '1', year: '2021' },
        },
        userType: 'birthMother',
        expected: 'COMPLETED',
      },
