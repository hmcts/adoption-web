...
describe('la-portal > laPortalSequence', () => {
  test('should contain 52 entries in sibling screen sequence', () => {
    ...
    expect(laPortalSequence[47].url).toBe('/la-portal/review-pay-submit/check-your-answers');
    expect(laPortalSequence[47].contentDir).toBe('MOCK_BASE_DIR/../review-pay-submit/check-your-answers');
    expect(laPortalSequence[47].getNextStep({})).toBe('/la-portal/review-pay-submit/confirmation');

    expect(laPortalSequence[48].url).toBe('/la-portal/review-pay-submit/confirmation');
    expect(laPortalSequence[48].contentDir).toBe('MOCK_BASE_DIR/../review-pay-submit/confirmation');
