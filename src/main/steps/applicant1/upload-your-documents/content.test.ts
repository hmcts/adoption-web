...
//   x.innerHTML = generatedContent.cannotUploadYouCanPost as string;
//   let y = document.createElement('div');
//   y.innerHTML = cannotUploadYouCanPost;
//   console.log(x.innerText === y.innerText);
//   expect(generatedContent.cannotUploadYouCanPost).toEqual(cannotUploadYouCanPost?.trim());
...
//     expect((adopAgencyOrLaName.label as Function)(generateContent(commonContent))).toBe(enContent.uploadFiles);
...
//     expect((adopAgencyOrLaPhoneNumber.label as Function)(generateContent(commonContent))).toBe(enContent.uploadFiles);
