...
describe('applicant1Sequence', () => {
  test('should contain 12 entries in applicant 1 screen sequence', () => {
    ...
    expect(applicant1Sequence[0].url).toBe('/start-placement');
    expect(applicant1Sequence[0].showInSection).toBe('aboutApplicant1');
    expect(applicant1Sequence[0].getNextStep({})).toBe('/applying-with');

    expect(applicant1Sequence[1].url).toBe('/applying-with');
    expect(applicant1Sequence[1].showInSection).toBe('aboutApplicant1');
    expect(applicant1Sequence[1].getNextStep({})).toBe('/task-list');

    expect(applicant1Sequence[2].url).toBe('/date-child-moved-in');
    expect(applicant1Sequence[2].showInSection).toBe('aboutApplicant1');
    expect(applicant1Sequence[2].getNextStep({})).toBe('/task-list');

    expect(applicant1Sequence[3].url).toBe('/applicant1/full-name');
    expect(applicant1Sequence[3].showInSection).toBe('aboutApplicant1');
    expect(applicant1Sequence[3].getNextStep({})).toBe('/applicant1/other-names');

    expect(applicant1Sequence[4].url).toBe('/applicant1/other-names');
    expect(applicant1Sequence[4].showInSection).toBe('aboutApplicant1');
    expect(applicant1Sequence[4].getNextStep({})).toBe('/applicant1/dob');

    expect(applicant1Sequence[5].url).toBe('/applicant1/dob');
    ...
    expect(applicant1Sequence[8].url).toBe('/applicant1/address/lookup');
    expect(applicant1Sequence[8].showInSection).toBe('aboutApplicant1');
    expect(applicant1Sequence[8].getNextStep({})).toBe('/applicant1/address/select');

    expect(applicant1Sequence[9].url).toBe('/applicant1/address/select');
    ...
    expect(applicant1Sequence[10].url).toBe('/applicant1/address/manual');
