...
describe('PlacementOrderPostController', () => {
  ...
  describe('when there are no form errors', () => {
    ...
    describe('and when there is a selectedPlacementOrderId', () => {
      ...
      test.skip('should set the formData fields in userCase placementOrders session data', async () => {
      ...
      test.skip('should redirect to correct screen', async () => {
  ...
  describe('when there are form errors', () => {
    ...
    test.skip('should save the errors in session', async () => {
      await controller.post(req, res);
      expect(req.session.errors).toEqual(['MOCK_ERROR']);
      expect(req.session.save).toHaveBeenCalled();
    });

    test.skip('should redirect to same page', async () => {
      await controller.post(req, res);
