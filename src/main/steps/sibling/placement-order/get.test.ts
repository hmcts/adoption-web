...
describe('PlacementOrderGetController', () => {
  ...
  describe('when there is no selectedPlacementOrderId in userCase', () => {
    test.skip('should generate random placementOrderId', async () => {
  ...
  describe('when there is a selectedPlacementOrderId in userCase', () => {
    test.skip('should not generate random placementOrderId', async () => {
  ...
  describe('when there is no placementOrder with selectedPlacementOrderId in userCase', () => {
    test.skip('should create a blank placementOrder with generated placementOrderId', async () => {
      req.locals.api.triggerEvent.mockResolvedValue({
        selectedPlacementOrderId: '1609459200000',
        placementOrders: [{ placementOrderId: '1609459200000' }],
      });
  ...
  describe('when there is a placementOrder with selectedPlacementOrderId in userCase', () => {
    test.skip('should not create a blank placementOrder', async () => {
      req = mockRequest({
        session: {
          userCase: {
            selectedPlacementOrderId: 'MOCK_PLACEMENT_ORDER_ID',
  ...
  describe('when there is "add" query param', () => {
    ...
    test.skip('should create a blank placementOrder with "add" query param\'s value as placementOrderId', async () => {
      req.locals.api.triggerEvent.mockResolvedValue({
    ...
    test.skip('should reset the addAnotherPlacementOrder in userCase', async () => {
    ...
    test.skip('should remove the query param and redirect', async () => {
      await controller.get(req, res);
  ...
  describe('when there is "change" query param', () => {
    ...
    test.skip('should set the selectedPlacementOrderId in userCase', async () => {
      req.locals.api.triggerEvent.mockResolvedValue({ selectedPlacementOrderId: 'MOCK_ID' });
      await controller.get(req, res);
  ...
  describe('when there is "remove" query param', () => {
    ...
    test.skip('should remove the placementOrder from userCase placementOrders list', async () => {
      req.locals.api.triggerEvent.mockResolvedValue({
  ...
  test.skip('saves the placementOrders and selectedPlacementOrderId in session', async () => {
    await controller.get(req, res);
