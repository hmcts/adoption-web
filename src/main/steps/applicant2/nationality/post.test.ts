...
// describe('applicant2 > NationalityPostController', () => {
//   let req;
//   let res;
//   let controller;
...
//         test('should add the country in userCase applicant2AdditionalNationalities session data', async () => {
//           await controller.post(req, res);
//           expect(req.session.errors).toEqual([]);
//           expect(req.session.userCase.applicant2AdditionalNationalities).toEqual(['MOCK_COUNTRY']);
...
//         await controller.post(req, res);
//         expect(req.session.errors).toEqual([]);
//         expect(req.session.userCase.applicant2AdditionalNationalities).toEqual([]);
//         expect(req.session.save).toHaveBeenCalled();
//         expect(mockGetNextStepUrl).toHaveBeenCalledWith(req, { applicant2AdditionalNationalities: [] });
//       });
//     });
//   });
...
//     test('should set the formData fields in userCase applicant2AdditionalNationalities session data', async () => {
//       await controller.post(req, res);
//       expect(req.session.errors).toEqual([]);
//       expect(req.session.userCase.applicant2AdditionalNationalities).toEqual(['MOCK_COUNTRY']);
//       expect(req.session.save).toHaveBeenCalled();
