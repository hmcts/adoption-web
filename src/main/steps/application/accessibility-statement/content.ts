...
const cy = {
  ...
  contactCourtDirectly:
    "Os oes gennych gwestiwn am hygyrchedd yn ein llysoedd teulu, gallwch <a href='https://www.find-court-tribunal.service.gov.uk/services/childcare-and-parenting/adoption/search-by-postcode?lang=cy' class='govuk-link' target='_blank' lang='cy'>gysylltu â'r llys yn uniongyrchol</a>.",
  contactTextRelay:
