...
const cy: typeof en = () => ({
  ...
  websiteUsageCookiesParagraph5: 'Rhestr o gwcis google analytics a ddefnyddiwyd.',
  ...
  introMessageCookiesAriaDescribedby: 'Rhestr o gwcis rhagarweiniol a ddefnyddiwyd.',
  introMessageCookieName1: 'seen_cookie_message',
  ...
  sessionCookiesAriaDescribedby: 'Rhestr o gwcis sesiwn a ddefnyddiwyd.',
  sessionCookieName1: 'connect.sid',
  ...
  identityCookiesAriaDescribedby: 'Rhestr o gwcis awdurdodi a ddefnyddiwyd.',
  identityCookieName1: '__auth-token',
  ...
  securityCookiesAriaDescribedby: "Rhestr o'r cwcis diogelwch a ddefnyddiwyd.",
  securityCookieName1: 'TSxxxxxxxx',
