...
const enContent = {
  ...
  referenceNumber: 'Your reference number<br><strong>1234</strong>',
...
const cyContent = {
  ...
  referenceNumber: 'Your reference number<br><strong>1234</strong> (in welsh)',
  emailSentConfirmation:
...
describe('application submmitted', () => {
  const commonContent = { language: 'en', userCase: { hyphenatedCaseRef: '1234' } } as CommonContent;
